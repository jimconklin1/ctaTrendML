function RiskAssetAllocation2_LandR(cfg,params)
...
switch riskType 
    ...
    case 'Intrinsic'
        ...
        fDataPeriods = 3; 
    otherwise
        factorDataTable = readtable(filePath + "\\MonthlyFactorDataQ12021.csv");
        fDataPeriods = 1; 
end
...
keySet = {'GlobalEquity','PvtEqBO','DirEqty','PvtEqRE','PvtEqFT','AbsRtn','HFBeta'};
