...
% The result of the test is returned in H = 1 indicates a rejection of the
% null hypothesis at the alpha significance level. Very low p-values
% suggest the Nully Hypothesis is rejected, therefore there IS a trend.
...
% -- NOTE --
% The significance level of a test is a threshold of probability agreed to
% before the test is conducted. A typical value of alpha is 0.05. 
...
% --OUTPUTS --
% H = test result [1] Reject of Null Hypthesis 
