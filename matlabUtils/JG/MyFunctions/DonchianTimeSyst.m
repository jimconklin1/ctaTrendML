function[s, sumprofit, sumgrossprofit]  =  DonchianTimeSyst(o, h, l, c, Lookback, MaxHPShort, MaxHPLong)
%
%__________________________________________________________________________
%
% DONNCHIAN WITH TIME EXIT SYSTEM
%
%__________________________________________________________________________
%
%__________________________________________________________________________
...
for i=144:nsteps   
    ...
    % No extra condition...................................................  
    % Enter Short Stock------------------------------------------------
    if  s(i-1)~=-1 && c(i)<MinLowEnterShort(i-1)    
        % Signal
        s(i)=-1;  
        ...
        HoldShort(i)=0;         
    % Hold Short Stock.................................................
    elseif s(i-1)==-1 && c(i)<MaxHighExitShort(i-1) && HoldShort(i-1)<MaxHPShort
        % Keep Signal
        s(i)=-1;  
        % Keep nb of shares
        nb(i)=nb(i-1);
    ...
    % Enter Long Stock-------------------------------------------------
    elseif s(i-1)~=1 && c(i)>MaxHighEnterLong(i-1)  
        % Signal
        s(i)=+1;  
        % Compute Number of Shares
        nb(i)=1;%capital/p(i);          
        ...
        HoldLong(i)=0;
    % Hold Long Stock...................................................
    elseif s(i-1)==1 && c(i)>MinLowExitLong(i-1) &&  HoldLong(i-1)<MaxHPLong
        % Keep Signal
        s(i)=+1;
        % Keep nb of shares
        nb(i)=nb(i-1);          
