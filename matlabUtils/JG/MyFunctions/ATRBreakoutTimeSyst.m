function[s, sumprofit, sumgrossprofit]  =  ATRBreakoutTimeSyst(o, h, l, c,ATRParameters, ma, MaxHPShort, MaxHPLong)
%
%__________________________________________________________________________
%
% SIMPLE ATR BREAKOUT SYSTEM
%
%__________________________________________________________________________
%
%__________________________________________________________________________
...
%
% Compute ATR--------------------------------------------------------------
LookbackATR=ATRParameters(1,1);
atr = ATRFunction(c,h,l,LookbackATR,LookbackVolat);
%
...
for i=144:nsteps   
    ...
    % No extra condition...................................................  
    % Enter Short Stock------------------------------------------------
    if  s(i-1)~=-1 && c(i)<ma(i) - ATRParameters(1,2) * atr(i) 
        % Signal
        s(i)=-1;  
    ...
    % Enter Long Stock-------------------------------------------------
    elseif s(i-1)~=1 && c(i) > ATRParameters(1,3) * atr(i) 
        % Signal
        s(i)=+1;  
        % Compute Number of Shares
        nb(i)=1;%capital/p(i);          
