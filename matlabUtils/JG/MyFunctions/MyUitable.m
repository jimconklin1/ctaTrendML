function [varargout] = MyUitable(varargin)
...
tb.hAxes = hAxes;
tb.data = data;
tb.geom.axesPos = get(hAxes,'position');%hAxes
...
if tb.geom.nRows*tb.geom.nCols > 4000
...
if (tb.geom.cellW < 3995) || (tb.geom.cellH < 17)   %fontsize=7 works well with cellH=17
