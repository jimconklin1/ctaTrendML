...
%
%   [content, index] = vlookup(m, e, column, lookcolumn) 
%   look for 'e' in 
...
% cherche element 'a' dans la seconde colonne de la matrice m et si
% tu le trouves, renvoie l'element de la 3ieme colonne sur la meme ligne
% content = {[2 3], 1};
% index = [1;3]
%__________________________________________________________________________
