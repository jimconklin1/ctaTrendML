...
% This version used for the SAA analysis of M2M assets only for GI: 
RiskAssetAllocation2_7gi(assetView,filePath,rebalPeriods,utilityFunction,utilityParam,shrinkageRP,longOnly,liquidationLimit,RBCLimit,ICLimit,illiquidLimit,varianceTarget,capCons,riskType,client);
