...
% La fonction renvoie pdi (+DI), mdi (-DI) et adx.
% Elle prend en paramètre :
% i) une time serie est représentée par une matrice de n lignes et 4 
% colonnes où les colonnes représentent respectivment (O,H,L,C).
% ii) Un lag représentant le lissage choisi
% Rem : le code n'est pas encore optimisé.
%
function [pdi,mdi,adx] = DirectionalIndexFunction(H,L,C, lag_dm)
