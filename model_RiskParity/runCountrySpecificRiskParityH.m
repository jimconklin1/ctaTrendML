function [outStruct,outStruct2,simTrackOutStruct] = runCountrySpecificRiskParityH(ctx, simConfig, riskConfig) 
...
hrpWts = HRPwts(dataStruct);
portSim = computeWeightsHRP(dataStruct,riskWts,annPortVol,omega,hrpWts); 
