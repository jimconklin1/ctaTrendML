function [F,c_v] = GrangerCausalityTest(x,y,alpha,max_lag)
...
if F > c_v
	...
	disp('The second variable DOES granger cause the first variable.');
	
else

	disp('The second variable DOES NOT granger cause the first variable.');
