function [o,r] = flooredReturnTest(hrtns,frtns,rfrtns,hHeader,fHeader,outlierThreshold,verbose)
...
if verbose
    fprintf("**********Floored-Return Regression Results for %s in term of %s**********\n", char(hHeader(1)),char(fHeader(1)));
    ...
    plot(x1,beta(1) + beta(2)*x1 +beta(3)*max(x1,0) , 'g')
