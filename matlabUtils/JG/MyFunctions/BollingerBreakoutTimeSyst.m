function[s, sumprofit, sumgrossprofit]  =  BollingerBreakoutTimeSyst(o, h, l, c, BollingerParameters, MaxHPShort, MaxHPLong)
%
%__________________________________________________________________________
%
% SIMPLE BOLLINGER BREAKOUT SYSTEM
%
%__________________________________________________________________________
%
%__________________________________________________________________________
...
% Compute Bollinger--------------------------------------------------------
TroncateVol=10e10;
method=BollingerParameters(1,1);
MAPeriod=BollingerParameters(1,2);
StdPeriod=BollingerParameters(1,3);
NbLow=BollingerParameters(1,4);
NbUp=BollingerParameters(1,5);
[LowBoll,UpBoll,PctB,ma] = BollingerFunction(c,method,MAPeriod,StdPeriod,TroncateVol,NbLow,NbUp);
%
...
for i=144:nsteps   
    ...
    if  s(i-1)~=-1 && c(i)<LowBoll(i) 
        ...
        HoldShort(i)=0;         
    % Hold Short Stock.................................................
    elseif s(i-1)==-1 && c(i)<ma(i) && HoldShort(i-1)<MaxHPShort 
        % Keep Signal
        s(i)=-1;  
        % Keep nb of shares
        nb(i)=nb(i-1);
    ...
    elseif s(i-1)~=1 && c(i)>UpBoll(i)  
        ...
        HoldLong(i)=0;
    % Hold Long Stock...................................................
    elseif s(i-1)==1 && c(i)>ma(i) &&  HoldLong(i-1)<MaxHPLong
        % Keep Signal
        s(i)=+1;
        % Keep nb of shares
        nb(i)=nb(i-1);          
