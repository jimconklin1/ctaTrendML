...
%I3=eye(3);
%delta_T=1;
%Kalman_Params.A = [I3 delta_T*I3; 0*I3 I3];
%Kalman_Params.process_noise_var2=0.01;
%Kalman_Params.measurement_noise_var2 =0.01; 
%Kalman_Params.estimate_error_var2 =0.01;
%Kalman_Params.kalman_gain =0.01;
%Kalman_Params.velocity =0.01;
%Kalman_Params.deta_T =1;
%B = 0;
%H = 1 
%==========================================================================
