function[adm,admup, admdown] = BloombergTrenderEnhanced(o,h,l,c,TrenderParameters)
    ...
    elseif MethodTrender==3
        ...
        for i=start_time+1:nsteps 
            ...
            if c(i)>adm(i-1)
                ...
                if c(i)<EMAMidPoint(i) || l(i)<adm(i)
                    adm(i)=adm(i-1);
                end
            end
            % Trender Down.................................................          
            if c(i)<adm(i-1)    
                ...
                if c(i)>EMAMidPoint(i) || h(i)>adm(i)
                    adm(i)=adm(i-1);
                end
            end            
            % Switch from Trender Up to Trender Down.......................
            if c(i-1)>adm(i-1) && c(i)<adm(i-2)
                adm(i)=EMAMidPoint(i) + 0.5 * EMATR(i);  
            end
            % Switch from Trender Down to Trender Up.......................
