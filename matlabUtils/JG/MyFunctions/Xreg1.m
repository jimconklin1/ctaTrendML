function[equi, stime, s5, s8, s13, s21,...
    s34, s55, s89, s144, s233] = Xreg1(x,ema5,ema8,ema13,ema21,ema34,ema55,ema89,ema144,ema233,Lookback)
%
...
for j=1:ncols
    ...
    for i=start_date(1,1)+Lookback:nsteps
        ...
        Myendo = [ cte, TimeTrend, ema5(i-Lookback+1:i,j), ema8(i-Lookback+1:i,j), ema13(i-Lookback+1:i,j), ...
       ...
       stime(i,j) = b(2,1);
       s5(i,j) = b(3,1);    s8(i,j) = b(4,1);
       s13(i,j) = b(5,1);   s21(i,j) = b(6,1);
       s34(i,j) = b(7,1);   s55(i,j) = b(8,1);
       s89(i,j) = b(9,1);   s144(i,j) = b(10,1);
       s233(i,j) = b(11,1);
        equi(i,j)=myeq;
    end
end
