function etd = ERTDep_AssetUploaded(riskfactor, c, tday_rf, tday_a, window)
...
for i=6:nrows
    if c_merged(i,1) >= 1.10 * c_merged(i-1,1) || ...
        ...
        c_merged_tailrisk(i,1)=NaN;
        c_merged_tailrisk(i,2)=NaN;
    end
end    
...
window = 30;
b = robustfit(cmtr(nrows-window:nrows,1),cmtr(nrows-window:nrows,2));
