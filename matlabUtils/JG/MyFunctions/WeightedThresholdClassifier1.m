%function [estimateclass,err,h] = WeightedThresholdClassifier1(datafeatures,dataclass,dataweight)
...
% note: -1e-10 and +1e-10 guarantee max-min is > 0

% Make a weighted histogram of the two classes
% use @minus as accumarray needs positive integer subscripts
...
h.threshold = thr; 
h.direction = dir;
estimateclass=ApplyClassTreshold1(h,datafeatures);
