function[s, sumprofit, sumgrossprofit]  =  Donchian(o, h, l, c, Lookback)
%
%__________________________________________________________________________
%
% SIMPLE DONNCHIAN SYSTEM
%
%__________________________________________________________________________
%
%__________________________________________________________________________
...
for i=144:nsteps   
    ...
    if  s(i-1)~=-1 && c(i)<MinLowEnterShort(i-1)    
        ...
        HoldShort(i)=0;         
    % Hold Short Stock.................................................
    elseif s(i-1)==-1 && c(i)<MaxHighExitShort(i-1) 
        % Keep Signal
        s(i)=-1;  
        % Keep nb of shares
        nb(i)=nb(i-1);
    ...
    elseif s(i-1)~=1 && c(i)>MaxHighEnterLong(i-1)  
        ...
        HoldLong(i)=0;
    % Hold Long Stock...................................................
    elseif s(i-1)==1 && c(i)>MinLowExitLong(i-1) 
        % Keep Signal
        s(i)=+1;
        % Keep nb of shares
        nb(i)=nb(i-1);          
