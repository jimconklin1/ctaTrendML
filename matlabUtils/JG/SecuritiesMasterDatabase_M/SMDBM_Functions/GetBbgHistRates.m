function data = GetBbgHistRates(ConBbg, TickerName, StartDate, EndDate, method)
%
...
switch method
    ...
    case {'weekly', 'w'}     
        databbg = history(ConBbg, TickerName, {'PX_OPEN', 'PX_HIGH' ,'PX_LOW','PX_LAST'}, StartDate, EndDate, 'weekly');  
    case {'monthly', 'm'}        
        databbg = history(ConBbg, TickerName, {'PX_OPEN', 'PX_HIGH' ,'PX_LOW','PX_LAST'}, StartDate, EndDate, 'monthly');  
end
%
