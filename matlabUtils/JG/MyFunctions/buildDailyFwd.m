...
function p = buildDailyFwd(o,h,l,c,vwap, fwd, dayCount, method, OpenWgt)
%
...
%
% -- Chose execution price (always push 1 bar forward)
switch method
    case {'open'}
        p(1:nsteps-1,:) = o(2:nsteps,:) + (fwd(1:nsteps-1,:) ./ 10000) ./ dayCount;
        p(nsteps,:) = p(nsteps-1,:);
    case{'atp'}
