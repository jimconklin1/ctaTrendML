function[s, sumprofit, sumgrossprofit]  =  TripleMATimeSyst(o, h, l, c, maf, mas, mavs,  MaxHPShort, MaxHPLong)
%
...
for i=144:nsteps   
    ...
    if Model==1     
        % Enter Short Stock------------------------------------------------
        if  s(i-1)~=-1 && maf(i)<mas(i) && c(i)<mavs(i)    
            % Signal
            s(i)=-1;  
            ...
            HoldShort(i)=0;         
        % Hold Short Stock.................................................
        elseif s(i-1)==-1 && maf(i)<mas(i) && HoldShort(i-1)<MaxHPShort
            % Keep Signal
            s(i)=-1;  
            % Keep nb of shares
            nb(i)=nb(i-1);
        ...
        % Enter Long Stock-------------------------------------------------
        elseif s(i-1)~=1 && maf(i)>mas(i) && c(i)>mavs(i) 
            % Signal
            s(i)=+1;  
            % Compute Number of Shares
            nb(i)=1;%capital/p(i);          
            ...
            HoldLong(i)=0;
        % Hold Long Stock...................................................
        elseif s(i-1)==1 && maf(i)>mas(i) &&  HoldLong(i-1)<MaxHPLong
            % Keep Signal
            s(i)=+1;
            % Keep nb of shares
            nb(i)=nb(i-1);          
