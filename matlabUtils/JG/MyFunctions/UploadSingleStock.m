function[tday, tdaynum, o,h,l,c, vwap, volume, areco] = UploadSingleStock(dirname, StockName, sheetname)
...
%
    ...
    o=num(:,1); h=num(:,2);l=num(:,3); c=num(:,4); vwap=num(:,5);
    volume=num(:,6); areco=num(:,7);
    %
    % -- Clean Data --
    ...
    for i=2:length(o)
        ...
        if isnan(areco(i)), vwap(i)=areco(i-1); end
    end    
    %
