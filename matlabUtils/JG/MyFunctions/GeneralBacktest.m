...
runacp=0;
if runacp==1
    y = rollingtimeacp(c,144, 8, 5);
    fa1=y(:,1,1); fa2=y(:,1,2); fa3=y(:,1,3); fa4=y(:,1,4); fa5=y(:,1,5);
end
%
...
for i=144:nsteps   
    ...
    elseif s(i-1)~=1 && fa1(i)<fa2(i)
        ...
        HoldLong(i)=0;
    % Hold Long Stock...................................................
    elseif s(i-1)==1 && fa1(i)<fa2(i) && HoldLong(i-1)<=8 
        % Keep Signal
        s(i)=+1;
        % Keep nb of shares
        nb(i)=nb(i-1);          
