function[s, sumprofit, sumgrossprofit]  =  DonchianFilterSyst(o, h, l, c, Lookback, maf, mas)
%
%__________________________________________________________________________
%
% DONNCHIAN WITH MOVING AVERAGE FILTER SYSTEM
%
%__________________________________________________________________________
%
%__________________________________________________________________________
...
for i=144:nsteps   
    ...
    if  s(i-1)~=-1 && c(i)<MinLowEnterShort(i-1)  && maf(i)<mas(i)  
        ...
        HoldShort(i)=0;         
    % Hold Short Stock.................................................
    elseif s(i-1)==-1 && c(i)<MaxHighExitShort(i-1) && maf(i)<mas(i)  
        % Keep Signal
        s(i)=-1;  
        % Keep nb of shares
        nb(i)=nb(i-1);
    ...
    elseif s(i-1)~=1 && c(i)>MaxHighEnterLong(i-1)  && maf(i)>mas(i) 
        ...
        HoldLong(i)=0;
    % Hold Long Stock...................................................
    elseif s(i-1)==1 && c(i)>MinLowExitLong(i-1) && maf(i)>mas(i) 
        % Keep Signal
        s(i)=+1;
        % Keep nb of shares
        nb(i)=nb(i-1);          
